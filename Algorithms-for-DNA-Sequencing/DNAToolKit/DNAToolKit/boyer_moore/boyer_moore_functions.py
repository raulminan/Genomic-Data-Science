...
def bm_exact_matching(pattern: str, text: str, boyer_moore: BoyerMoore) -> list:
    ...
    # TODO test if the function works without passing a bm object
    return occurrences
...
def bm_approximate_matching(pattern: str, text: str, max_mismatches: int) -> list:
    ...
    for i in range(max_mismatches+1):
        ...
        matches = bm_exact_matching(pattern[start:end], p_bm, text)
